    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'You can contact our support team through the contact form, check this FAQ section, or email us directly at makercostapp@gmail.com. Pro users receive priority support with faster response times.'
        }
      ]
    },
    {
        ...
        <div className="mb-12">
          <div className="relative max-w-md mx-auto">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
            />
          </div>
        </div>
        ...
        <div className="mt-12 text-center">
          <div className="bg-blue-50 dark:bg-gray-800 rounded-lg p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="mailto:makercostapp@gmail.com"
