      ...
      <div className="space-y-4 mb-8">
        {machines.length === 0 ? (
          <div className="text-center py-12 bg-gray-50 rounded-lg">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">No machines yet</h3>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by adding your first machine.</p>
            <div className="mt-6">
              <button
                onClick={() => setShowForm(true)}
                className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 text-white py-2 px-4 rounded-md font-medium transition-colors cursor-pointer"
              >
          ...
          machines.map((machine) => (
            <div key={machine.id} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                ...
                <div>
                  <span className="text-gray-500 dark:text-gray-400">Hours/Year:</span>
                  <p className="font-medium">{machine.hoursPerYear.toLocaleString()}</p>
                </div>
                <div>
                  <span className="text-gray-500 dark:text-gray-400">Maintenance/Year:</span>
                ...
                <div>
                  ...
                  <p className="font-medium text-green-600 dark:text-green-400">{getCurrencySymbol(shopData.currency)}{calculateHourlyRate(machine).toFixed(2)}/hr</p>
                </div>
              </div>
            </div>
          ))
