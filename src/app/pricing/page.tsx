        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            <div className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">{plans.free.description}</p>
            ...
            <button
              ...
              className="w-full bg-gray-900 dark:bg-gray-700 text-white py-3 px-6 rounded-lg font-medium hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors mb-8"
            >
              Get Started Free
            </button>
            ...
            <div className="space-y-4">
              ...
              {plans.free.limitations.length > 0 && (
                <>
                  <h4 className="font-semibold text-gray-900 dark:text-white mt-6">Limitations:</h4>
                  <ul className="space-y-3">
          ...
          <div className={`bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 relative ${
            plans.pro.popular ? 'border-2 border-blue-500' : 'border border-gray-200 dark:border-gray-700'
          }`}>
            {plans.pro.popular && (
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">{plans.pro.name}</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6">{plans.pro.description}</p>
              <div className="flex items-baseline">
            ...
            <div className="space-y-4">
              <h4 className="font-semibold text-gray-900 dark:text-white">Everything in Pro:</h4>
              <ul className="space-y-3">
        ...
        <div className="mt-20 text-center">
          <div className="bg-blue-50 dark:bg-gray-800 rounded-lg p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={() => handleGetStarted('free')}
                className="px-6 py-3 bg-gray-900 dark:bg-gray-700 text-white rounded-lg font-medium hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors"
              >
                Start Free
              </button>
              <button
