...
export default function CalculatorCTA() {
  return (
    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-8 text-center text-white my-8">
      <h3 className="text-2xl font-bold mb-4">Ready to Calculate Your Pricing?</h3>
      <p className="text-lg mb-6 opacity-90">
        Use our professional calculator to determine the optimal pricing for your products and maximize your profits.
      </p>
      <Link 
        href="/"
